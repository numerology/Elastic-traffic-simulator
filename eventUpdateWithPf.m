function [new_event_list, new_user_rates, new_user_workloads, ...
    new_user_active, new_user_timing, new_slice_users, current_time] = eventUpdateWithPf( event_list, user_rates, user_workloads,...
...
%event queue, the weight is dictated according to the weighting strata,
%while the rate allocation is according to weighted PF.
...
if (strcmp(cEvent.tag, 'arrival'))
    ...
    [cRate] = pf_cached(user_weights, capacities, user_demands, init_guess, cache);
